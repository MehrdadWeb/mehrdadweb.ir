<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center">
      <ul class="navbar-nav">
        <li class="nav-item font-weight-semibold d-none d-lg-block">پشتیبانی : +98 2992 709</li>
        <li class="nav-item dropdown language-dropdown">
          <a class="nav-link dropdown-toggle px-2 d-flex align-items-center" id="LanguageDropdown" href="#"
            ...
            <span class="profile-text font-weight-medium d-none d-md-block">English/Persian</span>
          </a>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
          <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
            <img class="img-xs rounded-circle" src="back/assets/images/faces/face29.jpg" alt="Profile image"> </a>
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
            <div class="dropdown-header text-center">
              <img class="img-md rounded-circle" src="back/assets/images/faces/face29.jpg" alt="Profile image">
              <p class="mb-1 mt-3 font-weight-semibold">مهرداد محمدی</p>
              <p class="font-weight-light text-muted mb-0">mehrdadmmg2012@gmail.com</p>
            </div>
            <a class="dropdown-item" href="https://mehrdadweb.ir/admin/">پروفایل من <span class="badge badge-pill badge-danger">1</span><i
