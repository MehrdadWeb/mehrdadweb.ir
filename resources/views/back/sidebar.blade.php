<!--  -->
<!-- منو ها pages/ui-features/buttons.html -->
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
                <div class="profile-image">
                    <img class="img-xs rounded-circle" src="back/assets/images/faces/face29.jpg" alt="profile image">
                    <div class="dot-indicator bg-success"></div>
                </div>
                <div class="text-wrapper">
                    <p class="profile-name">مهندس مهرداد محمدی</p>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.users') }}">مدیریت کاربران</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.categories') }}">مدیریت دسته بندی ها</a>
                    </li>
                    <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.services') }}">خدمات</a>
                    </li>
                    <li class=" nav-item">
