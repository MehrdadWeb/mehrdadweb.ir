...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            //   /* Get the text field */
            //   var copyText = document.getElementById("shortlink4");
    ...
    <div class="row mx-0 rwo_767_576">
        ...
        <div class="col-sm-10 px-0">
            ...
            <h1 class="header_class mb-5">
                <a class="text-decoration-none" href="http://mehrdadweb.ir">
                    ...
                    <!--<img class="gheychi" src="http://mehrdadweb.ir/front/img/URLShortener/gheychi.png" alt="کوتاه کننده لینک" width=" 50" style="transform: rotate(118.835deg);"  />-->
                </a>
            </h1>
            <!-- ====== END-2.header ====== -->
            <!-- ====== 3.main-1 ====== -->
            <div>
                ...
                <div class="form-group">
                    ...
                    <!--<button onclick="myFunction1()" id="copybtn"  class="btn url_btn url_copy">کپی</button>-->
                </div>
            </div>
            <!-- ====== END-2.main-1 ====== -->
            <!-- ====== 3.main-2 ====== -->
            <div class="d-flex secondarticle flex-column  justify-content-center align-content-center" style="margin-bottom: 100px;" dir="rtl" id="articlcolor">
                ...
                ما را در اینستاگرام دنبال کنید
                    ...
                    <!-- ====== 6-3th secondarticle ====== -->
                    <div class="box6 mb-1 mx-auto mb-5" id="switch3" style="width:32px;height:32px;background-color: #f8f9fa;">
        ...
        <!-- ====== FOOTER ====== -->
            ...
            <div class="container-fluid  footer1" dir="rtl" id="footerborder1">
                ...
                <div class="row">
                    <p class="p1">
                        کلیه حقوق محفوظ است ~ 2022 - 2020 &#169;طراحی و ارائه شده توسط <a class="text-decoration-none" href="http://mehrdadweb.ir/" target="_blank">مهندس مهرداد محمدی</a>
                    </p>
                </div>
            </div>
            <!-- ====== endfooter1 ====== -->
            <!-- ====== footer2 ====== -->
            <div class=" footer2" dir="rtl" id="footerborder2">
                <!-- ====== footer2-1 ====== -->
                <div class="d-flex  justify-content-center align-content-center">
                    <div>
