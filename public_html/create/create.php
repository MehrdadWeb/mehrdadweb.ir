...
<head>
    ...
    <!-- ====== 2 ====== -->
    <link rel="stylesheet" href="http://mehrdadweb.ir/front/css/create.css">
    <meta charset="UTF-8">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex flex-md-row justify-content-center align-content-center flex-container">
                        <input class="d-md-inline input1" type="text" id="longlink" name="longlink" value="" placeholder="http://mehrdadweb.ir/sample">
