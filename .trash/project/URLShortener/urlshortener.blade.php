    ...
    <script>
        $(document).ready(function() {
            ...
            $("#button4").click(function() {
                ...
                $.post("http://mehrdadweb.ir/shortlink/shortlink1.php", {
                    suggest: txt
                }, function(result) {
                    $("#shortlink2").hide();
                    $("#shortlink4").show();
                ...
                <div class="logsub" id="header_login">
                    <div class="mr-4 mt-2 form-group">
                        <div class="loginsec p-2 ">
                            ...
                            <span>|</span>
                            <span id="submit_span"><a class="text-decoration-none" href="http://mehrdadweb.ir/registration/register.php" style="color:black;">ثبت نام کاربر</a></span>
