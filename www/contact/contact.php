...
<head>
    ...
    <link rel="stylesheet" href="http://mehrdadweb.ir/front/css/contact.css">
    <meta charset="UTF-8">
        ...
        $(document).ready(function() {
            ...
            $("#switch1").click(function() {
                if ($("body").hasClass('firstbg')) {
                    ...
                    $("h4").addClass('ac-title2').removeClass('ac-title');
                    $("h3").addClass('class2-h3').removeClass('class-h3');
                    ...
                    $("h4").addClass('ac-title').removeClass('ac-title2');
                    $("h3").addClass('class-h3').removeClass('class2-h3');
                }
            ...
            $("#switch3").click(function() {
                if ($("body").hasClass('firstbg')) {
                    ...
                    $("#alink").addClass('button2').removeClass('button');
                    $("#arrowimg").addClass('arrow2').removeClass('arrow');
                    $("#title").addClass('ac-title2').removeClass('ac-title');
                    $("h4").addClass('ac-title2').removeClass('ac-title');
                    $("h3").addClass('class2-h3').removeClass('class-h3');
                } else if ($("body").hasClass('secondbg')){
                    $("body").addClass('firstbg').removeClass('secondbg');
                    ...
                    $("#alink").addClass('button2').removeClass('button');
                    $("#arrowimg").addClass('arrow').removeClass('arrow');
                    $("h4").addClass('title1').removeClass('title2');
                    $("h3").addClass('class-h3').removeClass('class2-h3');
                }
...
<body class="firstbg">
    ...
    <div class="row mx-0 rwo_767_576">
        ...
        <div class="col-sm-10 px-0">
            ...
            <div>
                <!-- ====== main-1-1 ====== -->
                <h2 class="title1" id="title">پشتیبانی و تماس</h2>
                <article class="content" id="content">
                    <p>
                        اگر می‌خواهید لینک کوتاه شده متخلفی را به ما گزارش دهید یا سوال و پیشنهادی در مورد کارکرد سایت کوتاه کننده
                        لینک دارید، می‌توانید از طریق ایمیل <span class="en">info@mehrdadweb.ir</span> و یا بصورت آنلاین با ما در ارتباط
                        باشید:
                        <a class="button" id="new_widget_button">
                            پشتیبانی آنلاین
                        <span id="unread_counter" style="display: none;">0</span></a>
                    </p>
                </article>
            ...
            <!-- ====== END-2.main-1 ====== -->
            <!-- ====== 3.main-2 ====== -->
            <section class="content accordion" style="margin-bottom: 100px;">
                <h3 class="class-h3">سوالات متداول</h3>
                <h4 class="ac-title">لینک‌های کوتاه شده تا چه مدت اعتبار دارد؟
                </h4><p class="ac-content" style="display: none;">لینک‌های کوتاه ایجاد شده دائمی است و تاریخ انقضا ندارد.</p>
                <h4 class="ac-title">چطور می‌توانم آدرس اختصاصی یا کمتر از ۶ کاراکتر در انتهای آدرس سایت داشته باشم؟
                </h4><p class="ac-content" style="display: none;">به این منظور می‌توانید هنگام کوتاه کردن لینک، از آدرس کوتاه دلخواه استفاده کنید.</p>
                <h4 class="ac-title">آیا آمار بازدید لینک‌ها، محدودیت زمانی یا سقف تعداد دارد؟
                </h4><p class="ac-content" style="display: none;">خیر، آمار بازدید ارائه شده برای لینک‌های کوتاه دائمی است و محدودیتی ندارد.</p>
                <h4 class="ac-title ">گزینه آمار خصوصی در سرویس کوتاه کننده لینک به چه منظور است؟
                </h4><p class="ac-content" style="display: none;">آمار بازدید لینک‌های کوتاه، بطور پیش‌فرض عمومی و برای همه قابل نمایش است؛ با انتخاب گزینه «آمار خصوصی»، آمار بازدید لینک ایجاد شده تنها از طریق لینک آمار ارائه شده به شما قابل نمایش خواهد بود.</p>
                <h4 class="ac-title ">هنگام کوتاه کردن لینک با آمار خصوصی، لینک آمار را ذخیره نکرده‌ام؛ چه‌کار کنم؟
                </h4><p class="ac-content" style="display: none;">برای دسترسی به آمار خصوصی لینک‌های خود، در همان مرورگری که لینک خود را کوتاه کرده‌اید، به صفحه اصلی سایت مراجعه کنید.
                </p>
                <h4 class="ac-title ">آیا کوچکی یا بزرگی حروف آدرس کوتاه هنگام تایپ آن مهم است؟
                </h4><p class="ac-content" style="display: none;">خیر، کوچکی یا بزرگی حروف، هنگام تایپ آدرس کوتاه اهمیتی ندارد.
                </p>
                <h4 class="ac-title ">آیا لینک‌های کوتاه شده در این سایت قابل اعتماد است؟
                </h4><p class="ac-content" style="display: none;">با اینکه تمام تلاش خود را برای مقابله با سواستفاده از این سرویس به کار گرفته‌ایم؛ اما تنها در صورتی که به فرستنده لینک اعتماد دارید، از آن لینک کوتاه استفاده کنید.
                </p>
                <h4 class="ac-title ">چطور قبل از اینکه روی لینک کوتاه کلیک کنم؛ از آدرس مقصد آن مطلع شوم؟
                </h4><p class="ac-content" style="display: none;">در صفحه «آمار بازدید لینک»، می‌توانید لینک کوتاه را وارد و آدرس مقصد آن را مشاهده کنید.
                </p>
            </section>
